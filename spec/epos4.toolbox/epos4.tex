...
\@pvspace{8.0pt}%
 ...
 ,\,}%
 \@x{\@s{8.2} EPOS\_ReadyToSwitchOn ,\, EPOS\_SwitchedOn ,\,
 EPOS\_OperationEnabled ,\,}%
 \@x{\@s{8.2} EPOS\_QuickStopActive ,\, EPOS\_FaultReactionActive ,\,
 EPOS\_Fault \}}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
...
\@x{\@s{56.14} \.{\land} epos\_state \.{\in} EPOS}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jan} 13 13:34:17 \ensuremath{CET} 2020 by \ensuremath{martin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
