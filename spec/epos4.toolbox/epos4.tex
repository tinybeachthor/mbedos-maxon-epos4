...
\@x{}\moduleLeftDash\@xx{ {\MODULE} epos4}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Possible \ensuremath{NMT} states
\end{cpar}%
\end{lcom}%
 \@x{ {\CONSTANT} NMT\_Booting ,\, NMT\_PreOperational ,\, NMT\_Operational
 ,\, NMT\_Stopped}%
\@pvspace{8.0pt}%
 \@x{ NMT \.{\defeq} \{ NMT\_Booting ,\, NMT\_PreOperational ,\,
 NMT\_Operational ,\, NMT\_Stopped \}}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES} nmt\_state ,\, nmt\_requested}%
\@pvspace{8.0pt}%
\@x{ vars \.{\defeq} {\langle} nmt\_state ,\, nmt\_requested {\rangle}}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
\@x{ TypeOK \.{\defeq} \.{\land} nmt\_state \.{\in} NMT}%
\@x{\@s{56.14} \.{\land} nmt\_requested \.{\in} NMT}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Received a \ensuremath{BootUp} message
\end{cpar}%
\end{lcom}%
\@x{ NMT\_BootUp \.{\defeq} \.{\land} nmt\_state \.{=} NMT\_Booting}%
\@x{\@s{81.52} \.{\land} nmt\_state \.{'} \.{=} NMT\_PreOperational}%
\@x{\@s{81.52} \.{\land} {\UNCHANGED} nmt\_requested}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{ NMT\_Transition\_Confirmed \.{\defeq} \.{\land} nmt\_state \.{\neq}
 nmt\_requested}%
\@x{\@s{144.78} \.{\land} nmt\_state \.{'} \.{=} nmt\_requested}%
\@x{\@s{144.78} \.{\land} {\UNCHANGED} nmt\_requested}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{ NMT\_EnterPreOperational \.{\defeq} \.{\land} \.{\lor} nmt\_state \.{=}
 NMT\_Operational}%
\@x{\@s{150.52} \.{\lor} nmt\_state \.{=} NMT\_Stopped}%
\@x{\@s{139.41} \.{\land} nmt\_requested \.{=} nmt\_state}%
\@x{\@s{139.41} \.{\land} nmt\_requested \.{'} \.{=} NMT\_PreOperational}%
\@x{\@s{139.41} \.{\land} {\UNCHANGED} nmt\_state}%
\@pvspace{8.0pt}%
 \@x{ NMT\_ResetCommunication \.{\defeq} \.{\land} \.{\lor} nmt\_state \.{=}
 NMT\_Operational}%
\@x{\@s{152.54} \.{\lor} nmt\_state \.{=} NMT\_PreOperational}%
\@x{\@s{152.54} \.{\lor} nmt\_state \.{=} NMT\_Stopped}%
\@x{\@s{141.43} \.{\land} nmt\_requested \.{=} nmt\_state}%
\@x{\@s{141.43} \.{\land} nmt\_requested \.{'} \.{=} NMT\_Booting}%
\@x{\@s{141.43} \.{\land} {\UNCHANGED} nmt\_state}%
\@pvspace{8.0pt}%
 \@x{ NMT\_ResetNode \.{\defeq} \.{\land} \.{\lor} nmt\_state \.{=}
 NMT\_Operational}%
\@x{\@s{105.27} \.{\lor} nmt\_state \.{=} NMT\_PreOperational}%
\@x{\@s{105.27} \.{\lor} nmt\_state \.{=} NMT\_Stopped}%
\@x{\@s{94.16} \.{\land} nmt\_requested \.{=} nmt\_state}%
\@x{\@s{94.16} \.{\land} nmt\_requested \.{'} \.{=} NMT\_Booting}%
\@x{\@s{94.16} \.{\land} {\UNCHANGED} nmt\_state}%
\@pvspace{8.0pt}%
 \@x{ NMT\_StartRemoteNode \.{\defeq} \.{\land} \.{\lor} nmt\_state \.{=}
 NMT\_PreOperational}%
\@x{\@s{136.06} \.{\lor} nmt\_state \.{=} NMT\_Stopped}%
\@x{\@s{124.95} \.{\land} nmt\_requested \.{=} nmt\_state}%
\@x{\@s{124.95} \.{\land} nmt\_requested \.{'} \.{=} NMT\_Operational}%
\@x{\@s{124.95} \.{\land} {\UNCHANGED} nmt\_state}%
\@pvspace{8.0pt}%
 \@x{ NMT\_StopRemoteNode \.{\defeq} \.{\land} \.{\lor} nmt\_state \.{=}
 NMT\_Operational}%
\@x{\@s{133.64} \.{\lor} nmt\_state \.{=} NMT\_PreOperational}%
\@x{\@s{122.53} \.{\land} nmt\_requested \.{=} nmt\_state}%
\@x{\@s{122.53} \.{\land} nmt\_requested \.{'} \.{=} NMT\_Stopped}%
\@x{\@s{122.53} \.{\land} {\UNCHANGED} nmt\_state}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
\@x{ Init\@s{4.12} \.{\defeq} \.{\land} nmt\_state \.{=} NMT\_Booting}%
\@x{\@s{39.83} \.{\land} nmt\_requested \.{=} NMT\_PreOperational}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} \.{\lor} NMT\_BootUp}%
\@x{\@s{39.83} \.{\lor} NMT\_Transition\_Confirmed}%
\@x{\@s{39.83} \.{\lor} \.{\lor} NMT\_EnterPreOperational}%
\@x{\@s{50.94} \.{\lor} NMT\_ResetCommunication}%
\@x{\@s{50.94} \.{\lor} NMT\_ResetNode}%
\@x{\@s{50.94} \.{\lor} NMT\_StartRemoteNode}%
\@x{\@s{50.94} \.{\lor} NMT\_StopRemoteNode}%
\@pvspace{8.0pt}%
\@x{ Live\@s{1.65} \.{\defeq} \A\, s \.{\in} NMT \.{:}}%
 \@x{\@s{47.05} ( nmt\_requested \.{=} s ) \.{\leadsto} ( nmt\_state \.{=} s
 )}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
 \@x{ Spec \.{\defeq} Init \.{\land} {\Box} [ Next ]_{ {\langle} vars
 {\rangle}} \.{\land} {\WF}_{ vars} ( Next )}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jan} 13 20:42:49 \ensuremath{CET} 2020 by \ensuremath{martin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Mon} \ensuremath{Jan} 13
 12:39:13 \ensuremath{CET} 2020 by \ensuremath{martin
}%
\end{cpar}%
\end{lcom}%
\end{document}
